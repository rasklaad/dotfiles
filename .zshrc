...
#alias pgcli='cd ~/instruments/pgcli && pipenv run pgcli'

setxkbmap -layout "us,ru" -option "grp:caps_toggle"
xset s 300 5

# enabled as screen-lock.service
...
# hotkeys mapping, defined in ~/.xbindkeysrc, https://wiki.archlinux.org/index.php/Xbindkeys
#xbindkeys 
